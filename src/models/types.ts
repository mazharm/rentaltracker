...
export type DataSource =
  | { type: 'own' }
  | { type: 'shared'; accountId: string; shareUrl: string; label: string; driveId?: string; itemId?: string };
...
/** Migrate old SharedAccount format to current — preserves all known fields */
